...
MAINTAINER dmitry.sobolev <dmitry.sobolev@gmail.com>

ARG MALMO_VERSION=Malmo-0.22.0-Linux-Ubuntu-16.04-64bit_withBoost
...
RUN apt-get update && \
  ...
  # Malmö
  wget -q -O /tmp/malmo.zip https://github.com/Microsoft/malmo/releases/download/0.22.0/${MALMO_VERSION}.zip && \
